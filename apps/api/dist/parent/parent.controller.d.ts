...
export declare class ParentController {
    ...
    overview(req: any, id: string): Promise<{
        learner: {
            tenantId: string;
            id: string;
            createdAt: Date;
    ...
    fees(req: any, id: string): Promise<({
        payments: {
            id: string;
            amount: number;
            invoiceId: string;
    ...
    applications(req: any, id: string): Promise<{
        tenantId: string;
        id: string;
        createdAt: Date;
        status: string;
    ...
    teachers(req: any, id: string): Promise<{
        teacher: {
            id: string;
            name: string | null;
            email: string;
    ...
    hostel(req: any, id: string): Promise<{
        application: ({
            preferredBuilding: {
                tenantId: string;
                id: string;
    ...
    hostelApply(req: any, id: string, body: any): Promise<{
        tenantId: string;
        id: string;
        status: string;
        updatedAt: Date;
    ...
    hostelConcern(req: any, id: string, body: any): Promise<{
        tenantId: string;
        id: string;
        createdAt: Date;
        status: string;
