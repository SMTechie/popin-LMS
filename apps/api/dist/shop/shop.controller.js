...
let ShopController = class ShopController {
    ...
    async getCatalog(since, page = "1", pageSize = "50", category, visibility, includeVariants = "true", includeImages = "true", status, ifNoneMatch, res, req) {
        if (!req.integration?.shopApiEnabled)
            throw new common_1.ForbiddenException("Shop API disabled");
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "Get shop catalog" }),
...
], ShopController.prototype, "getCatalog", null);
exports.ShopController = ShopController = __decorate([
    (0, swagger_1.ApiTags)("Shop Catalog"),
    (0, common_1.Controller)("api/v1/shop"),
