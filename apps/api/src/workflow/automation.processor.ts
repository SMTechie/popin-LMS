...
export class AutomationProcessor {
  static async handle(job: { data: { type: string; payload: Record<string, unknown> } }) {
    ...
    for (const rule of rules) {
      ...
      try {
        // TODO: evaluate conditions against payload. Placeholder assumes match.
        const actions = (version.actions as unknown[]) || [];
